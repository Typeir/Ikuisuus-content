...
- **Shield Collapse**:  
  As a **bonus action**, the shield can be collapsed into a **buckler (+1 AC against melee attacks, loses the Greatshield's slowing and dex-impeding properties)**. Re-expanding it takes a bonus action.
...
- **Firestorm** _(1/Short rest, or 3/Short rest if the wielder has mastery with Longswords)_:  
  As an action, you may fire a **divine shell** from your spiritual blunderbuss.
