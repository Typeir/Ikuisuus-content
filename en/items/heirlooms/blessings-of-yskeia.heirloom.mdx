...
- **Spiritual Conduit**:  
  When you cast [**_Spiritual Weapon_**](/en/library/spells/spiritual-weapon), the conjured weapon takes the form of a **divine blunderbuss**. It deals **[% 2d12 force %]**, has a **range of 30 feet**, and gains the **Loading** property (it can be fired every other round).
...
- **Firestorm** _(1/Repose, or 3/Repose if the wielder has mastery with Longswords)_:  
  ...
  - All creatures within a **20-foot radius sphere** must make a **Dexterity saving throw (DC = 9 + your Tier Bonus + your Wisdom modifier)**
