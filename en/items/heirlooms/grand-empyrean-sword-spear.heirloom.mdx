...
- **Frozen Riposte** _(1/Repose, or 3/Repose if wielder has Mastery with Sword-Spears)_:  
   After taking damage from a melee attack, you can use your reaction to make an immediate attack against the attacker. If this attack hits, it deals an additional [% 2d6 cold %].
