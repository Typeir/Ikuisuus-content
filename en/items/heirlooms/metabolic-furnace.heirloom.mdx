...
_legendary Monstrous Graft, nonmagical_
...
- **Wildlife, Monstrosities, or Humanoids**, dead **no more than 10 minutes** or **preserved magically/extremely cold**.
...
**Minor Action – Ignite Fuel**  
 You may expend **2 charges** to gain **resistance to fire and frost damage** for **1 minute**.
...
- You gain **immunity** to **fire and frost damage**.
- Creatures that **touch you or hit you** with melee attacks within [= 1 stride =] take **10 fire damage**.
...
- At the **start of each turn**, you **lose 3 charges**.
  ...
  - You can choose to end this effect early with a **Minor Action**.
- At the **end of the effect**, you take **[% 4d6 true %]** per charge spent as your **organs dissolve into sludge**.
