...
- On a **failure**, the subject takes **[% 6d6 poison %]** and must repeat the check
- If the procedure is **interrupted**, the graft is **rejected permanently**

- The graft is **mundane** and **permanent** unless surgically removed (destroyed on removal)
...
- **Venom Strike**  
  These attacks deal **[% 1d6 poison %]**, replacing the normal damage of unarmed strikes or natural attacks.
...
- **Venom Pulse** _(1/Repose, or 3/Repose with mastery)_:  
  When you take the **Attack action**, you may **replace one of your attacks** with a venom burst:
  - Target must make a **DC (18 + Tier Bonus) Constitution saving throw**
  - **On failure**: Target takes **[% 6d6 poison %]** and is **poisoned** until the end of their next turn
