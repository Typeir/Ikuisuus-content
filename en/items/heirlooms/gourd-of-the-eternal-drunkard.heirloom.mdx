...
<Heirloom
  rarity="Rare"
  attunement="by a Monk with the Drunken Master specialization"
  base="Bauble (Gourd)"
  burden="[= 1 burden =]">

A lacquered gourd carved with laughing Hiisi and inscribed with the proverb:  
...
If a creature not attuned or not a Drunken Master drinks from the gourd, they save Constitution against DC 16. Failing targets become [# kw:condition:poisoned #] for 1 hour and gain 1 level of [# kw:condition:Exhaustion #]. Saving targets become [# kw:condition:poisoned #] for 10 minutes.
...
A creature can drink from the gourd. If attuned and a Drunken Master, they gain 1 level of Inebriation (see Scroll of the Inebriated Warrior).
