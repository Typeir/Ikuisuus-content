...
_Rare (requires attunement by a Monk with the Drunken Master specialization)_  
_Consumable, Food and Drink_
...
- **Minor Action – Drink Deep**:  
  As a Minor Action, a creature can take a drink from the gourd. If the drinker is attuned and a **Drunken Master Monk**, they gain **1 level of Inebriation** (see _Scroll of the Inebriated Warrior_).
