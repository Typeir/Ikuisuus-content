...
If a creature not attuned or not a Drunken Master drinks from the gourd, they save CON against DC 16. Failing targets become [# kw:condition:poisoned #] for 1 hour and gain 1 level of [# kw:condition:Exhaustion #]. Saving targets become [# kw:condition:poisoned #] for 10 minutes.
