...
_Only usable by Pact of the Blade Villeins or Hexblade Villeins_
...
- **Fear Rend** _(1/Repose, or 3/Repose if the wielder has mastery with Longswords)_:  
...
- **Devastating Critical**:
  ...
  - When this weapon **critically strikes**, it deals **Force damage** along with an additional **[% 1d12 Force %]**.
