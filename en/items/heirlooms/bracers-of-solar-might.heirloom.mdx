...
<Feature cost="When you make an attack roll" recharge="at sunrise">

#### Solar guidance

You may expend your power to gain +10 accuracy on that roll. This bonus stacks with other effects, but only one bracer can be expended per attack.
