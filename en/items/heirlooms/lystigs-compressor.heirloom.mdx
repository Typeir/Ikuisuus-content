...
Forgoing a short rest, a compressor which requires 100gp in materials and proficiency with [Tinkering](/en/library/items/tools/tinkering) and [Alchemy](/en/library/items/tools/alchemy) can be crafted and fitted into a gun. A gun fitted with **Lystig's Compressor** will turn into a magical object.
