...
_Counts as a **Graviturgy Wizard** spellcasting focus_
...
- **Bite or Bludgeon**:
  The hammerhead can be **smooth** (maul) or **barbed** (harpoon). **When you make an attack with Deep Dredge, you decide its damage type** (bludgeoning or piercing) for that attack.
...
- **Magical Weapon**:
  Deep Dredge is a **+1 weapon**. You gain a **+1 accuracy and damage bonus** made with it, and attacks count as **magical** for overcoming resistance and immunity.

- **War Mage’s Weapon**:
  Deep Dredge **also functions as a Wand of the War Mage +1**: you gain a **+1 accuracy bonus on spell attacks and a +1 bonus to saving throws**, and your spell attacks **ignore half cover**.

- **Fling Conduit**:
  When **you cast *catapult***, treat the spell as **cast one slot level higher** than the slot you expend.

  * This applies **even if the hurled object is Deep Dredge** (its [= 5 burden =] weight qualifies for *catapult*).
...
- **Push**: *(active when dealing bludgeoning damage, only available if wielder has Mastery with Warhammers)*
  On a hit, you can **push** the target **[= 2 stride =]** away from you if it is no more than one size larger than you.
v
...
- **Undertow**: _(1/Repose, or 3/Repose if wielder has Mastery with Warhammers)_  
  When you hit a creature with this weapon, you can call upon the primordial brine pools to summon a grasping hand made out of dredge.
    - The target is immediately targeted by the [_Prasinus's Heavy Hand_](/en/library/spells/prasinuss-heavy-hand) spell, considering you the caster.
