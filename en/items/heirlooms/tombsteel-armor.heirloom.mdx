...
- **Type**: Heavy Armor (Any, Nullifying)
...
- **Cold Eternal**  
  While wearing Tombsteel Armor, any creature **without resistance or immunity to frost damage** must make a **DC 13 Constitution saving throw** at the **end of each hour**:
...
- **Grave Chill** _(Passive – 10 charges)_  
  The armor stores **up to 10 charges**, regaining **[% 1d4 +4 %] charges** at **midnight**
  - When a creature hits you with a **melee weapon attack**, you may expend **1 charge** to deal **10 frost damage** to the attacker, as **tombsteel rime splinters** lash outward from your frame
