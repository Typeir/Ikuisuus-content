...
- **Sap**  _(Only available if the wielder has mastery with Rapiers)_:  
  When you hit a creature, their **next attack roll** before your next turn is made at **disadvantage**

- **Parry and Riposte** _(1/Repose, or 3/Repose if the wielder has mastery with Rapiers)_:

  - When a creature makes a **melee attack** against you, use your **reaction** to force a **disadvantage reroll** (before result is known)
  - If the attack **misses**, you may **counterattack**, dealing an extra **[% 1d8 lightning %]**
  - When targeted by a **ranged attack**, you may attempt to **redirect it**:
    ...
    - **Success**: Redirect the attack at a target within **[= 6 stride =]/[= 12 stride =]**; you roll attack and damage as if the original attacker had aimed for them
...
- **Upkeep Penalty**:
  ...
  ***
  ...
  - The quiver flies toward the épée wielder if within **[= 120 stride =]**, traveling at:
  ...
  If the wielders are **separated by more than [= 120 stride =]**, the survivor gains **1 exhaustion per day at dawn** until the link is broken or restored.

  ### Retribution Mode

  While under **Fated Demise**, this weapon gains enhanced effects:

  - **Deflected Fate**_(3/Repose)_

  When you use **Deflecting Blade**, you may replace the usual redirect or counterattack with a **shockwave riposte**:

  - Every creature **within [= 1 stride =] of you** must make a **Dexterity saving throw**  
    (DC 10 + Dexterity modifier + tier bonus)
  - **On failure**: They take **[% 2d8 slashing %]**
  - If the deflected attack was **ranged**, creatures make the save **with advantage**

  > If the thread of fate is severed, this ability becomes a **1-charge feature**, recharging **daily at noon**, instead of using [# kw:Repose #] charges.
