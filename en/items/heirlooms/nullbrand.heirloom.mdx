...
Any other attempt to attune triggers a **DC 25 Charisma [RR](/en/library/rules/rolling-and-special-rolls) saving throw**.  
...
- **Sever** _(Requires Nullbrand Mastery)_  
  When you hit a creature with a melee attack, you may dispel a magic effect on the target. The target must succeed on a **Charisma [RR](/en/library/rules/rolling-and-special-rolls) saving throw (DC = 12 + your Proficiency Bonus + your Charisma modifier)**.
...
- **[_Erosion_](/en/library/rules/illnesses/erosion) is a stacking curse**.  
...
All creatures in that line must make a **Charisma [RR](/en/library/rules/rolling-and-special-rolls) saving throw (DC = 12 + your Proficiency Bonus + your Charisma modifier)**.
