...
A globe of burning flame appears and rolls across the ground, searing whatever it passes.
...
>  
> Any creature that ends its turn within 5 feet of the sphere must make a Dexterity saving throw. The creature takes [% 2d6 fire %] on a failed save, or half as much damage on a successful one.  
>  
