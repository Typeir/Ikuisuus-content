...
A hollow chime issues from the target as black rot crawls across the target's flesh.
...
>  
> The target must succeed on a Wisdom saving throw or take 1d8 dark damage. If the target is missing any of its hit points, it instead takes 1d12 dark damage.  
>  
