...
- **Chitin Claws**
  ...
  _Hit:_ 12 (2d6 + 4) slashing damage. If the target is a creature, it must succeed on a DC 12 Strength saving throw or be knocked prone.

- **Acidic Ventral Harpoon**
  _Melee Weapon Attack:_ +5 to hit, reach 10 ft., one target.  
  _Hit:_ 14 (2d8 + 4) piercing damage plus 7 (2d6) chemical damage. If the target is already prone, it suffers **maximum chemical damage**.

- **Tendril**
  _Melee Weapon Attack:_ +5 to hit, reach 10 ft., one target.  
  _Hit:_ 16 (2d10 + 4) piercing damage.
...
_When a Cerithol Lunam within 300 ft. takes damage:_  
