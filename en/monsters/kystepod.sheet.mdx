...
<BlendedImage src='/library/images/Kystepod.webp' alt='Kystepod' />
...
- **Acidic Ventral Harpoon**
  ...
  _Hit:_ 14 (2d8 + 4) piercing damage plus 7 (2d6) acid damage. If the target is already prone, it suffers **maximum acid damage**.
