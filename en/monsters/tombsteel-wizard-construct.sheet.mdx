...
| ------------------ | ---------------- | --------- |
| 16 (natural armor) | 153 ([% 18d10 +54 %]) | 50 ft.    |
...
- **Slam.** _Melee Weapon Attack:_ +9 to hit, reach 5 ft., one creature. _Hit:_ 8 ([% 1d8 +4 bludgeoning %]) plus 10 ([% 3d6 cold %]), and the target must succeed on a DC 16 Constitution saving throw or be paralyzed for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- **2nd level (1/day each)**: [_Hold Person_](/en/library/spells/hold-person), [_Invisibility_](/en/library/spells/invisibility), [_Mirror Image_](/en/library/spells/mirror-image)
- **3rd level (1/day each)**: [_Fireball_](/en/library/spells/fireball), [_Vampiric Touch_](/en/library/spells/vampiric-touch)
- **4th level (1/day)**: [_Dimension Door_](/en/library/spells/dimension-door)
- **5th level (1/day each)**: [_Cone of Cold_](/en/library/spells/cone-of-cold), [_Raise Dead_](/en/library/spells/raise-dead)
- **6th level (1/day)**: [_Chain Lightning_](/en/library/spells/chain-lightning)
