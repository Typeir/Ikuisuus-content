...
- **Slam.** _Melee Weapon Attack:_ +9 to hit, reach 5 ft., one creature. _Hit:_ 8 (1d8 + 4) bludgeoning damage plus 10 (3d6) cold damage, and the target must succeed on a DC 16 Constitution saving throw or be paralyzed for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
- **1st level (1/day)**: [_Shield_](https://dnd5e.wikidot.com/spell:shield)
- **2nd level (1/day each)**: [_Hold Person_](https://dnd5e.wikidot.com/spell:hold-person), [_Invisibility_](https://dnd5e.wikidot.com/spell:invisibility), [_Mirror Image_](https://dnd5e.wikidot.com/spell:mirror-image)
- **3rd level (1/day each)**: [_Fireball_](https://dnd5e.wikidot.com/spell:fireball), [_Vampiric Touch_](https://dnd5e.wikidot.com/spell:vampiric-touch)
- **4th level (1/day)**: [_Dimension Door_](https://dnd5e.wikidot.com/spell:dimension-door)
- **5th level (1/day each)**: [_Cone of Cold_](https://dnd5e.wikidot.com/spell:cone-of-cold), [_Raise Dead_](https://dnd5e.wikidot.com/spell:raise-dead)
- **6th level (1/day)**: [_Chain Lightning_](https://dnd5e.wikidot.com/spell:chain-lightning)
