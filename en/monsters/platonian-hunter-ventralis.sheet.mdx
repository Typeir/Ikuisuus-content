...
- **Thruster Axe-Kick** _(Gap Closer)_  
  ...
  **Effect**: Target must succeed on a **DC 18 Strength saving throw** or be knocked prone.  
  If the target takes damage, it [catches fire](/en/library/rules/conditions).
...
If the creature is already infected by any of the [_Black Rot_](/en/library/rules/illnesses/black-rot) effects, they instantly roll on the Table again.
...
- \*After a full day infected, the character must roll on the [_Black Rot_](/en/library/rules/illnesses/black-rot) Table.
