...
| **Trade Proficiencies**        | Choose one [Trade](/en/library/items/tools) (any artisan trade or [Music](/en/library/items/tools/music))                             |
| **Weapon Proficiencies**       | Simple weapons and Martial weapons with the Light property                                                                            |
| **Armor Training**             | None                                                                                                                                  |
| **Starting Equipment**         | Choose A or B:<br/>(A) Spear, 5 Daggers, a kit for your chosen [Trade](/en/library/items/tools), Explorer's Pack, 11 GP<br/>(B) 50 GP |
...
| Level | TB  | Martial Arts | Focus | Movement        | Vocation Features                                    |
| ----- | --- | ------------ | ----- | --------------- | ---------------------------------------------------- |
| 1     | +1  | [% 1d6 %]    | –     | –               | Martial Arts, Unarmored Defense                      |
| 2     | +1  | [% 1d6 %]    | 2     | +[= 2 stride =] | Monk's Focus, Unarmored Movement, Uncanny Metabolism |
| 3     | +1  | [% 1d6 %]    | 3     | +[= 2 stride =] | Deflect Attacks, Monk Specialization                 |
| 4     | +2  | [% 1d6 %]    | 4     | +[= 2 stride =] | Ability Score Improvement, Slow Fall                 |
| 5     | +2  | [% 1d8 %]    | 5     | +[= 2 stride =] | Extra Attack, Stunning Strike                        |
| 6     | +2  | [% 1d8 %]    | 6     | +[= 3 stride =] | Empowered Strikes, Specialization Feature            |
| 7     | +3  | [% 1d8 %]    | 7     | +[= 3 stride =] | Evasion                                              |
| 8     | +3  | [% 1d8 %]    | 8     | +[= 3 stride =] | Feat                                                 |
| 9     | +3  | [% 1d8 %]    | 9     | +[= 3 stride =] | Acrobatic Movement                                   |
| 10    | +4  | [% 1d8 %]    | 10    | +[= 4 stride =] | Heightened Focus, Self-Restoration                   |
| 11    | +4  | [% 1d10 %]   | 11    | +[= 4 stride =] | Specialization Feature                               |
| 12    | +4  | [% 1d10 %]   | 12    | +[= 4 stride =] | Feat                                                 |
| 13    | +5  | [% 1d10 %]   | 13    | +[= 4 stride =] | Deflect Energy                                       |
| 14    | +5  | [% 1d10 %]   | 14    | +[= 5 stride =] | Disciplined Survivor                                 |
| 15    | +5  | [% 1d10 %]   | 15    | +[= 5 stride =] | Perfect Focus                                        |
| 16    | +6  | [% 1d10 %]   | 16    | +[= 5 stride =] | Feat                                                 |
| 17    | +6  | [% 1d12 %]   | 17    | +[= 5 stride =] | Specialization Feature                               |
| 18    | +6  | [% 1d12 %]   | 18    | +[= 6 stride =] | Superior Defense                                     |
| 19    | +7  | [% 1d12 %]   | 19    | +[= 6 stride =] | Epic Boon                                            |
| 20    | +7  | [% 1d12 %]   | 20    | +[= 6 stride =] | Body and Mind                                        |
...
- **Patient Defense**: Take the **Disengage action** as a **Minor Action**, or spend 1 Focus Point to also take the **Dodge action**.
- **Step of the Wind**: Take the **Dash action** as a **Minor Action**, or spend 1 Focus Point to also **Disengage** and double your jump distance.

Focus Points recover on a **[# kw:Repose #] or [# kw:Recovery #]**.  
**Save DC 10 + Tier Bonus + Wisdom modifier**
