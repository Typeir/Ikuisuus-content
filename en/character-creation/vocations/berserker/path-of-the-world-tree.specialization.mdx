...
Berserkers who follow the Path of the World Tree connect with the cosmic tree **Yggdrasil** through their **Rage**. This tree grows among the Outer Planes, linking all realms together. These Berserkers draw on its magic for vitality and as a means of dimensional travel.
