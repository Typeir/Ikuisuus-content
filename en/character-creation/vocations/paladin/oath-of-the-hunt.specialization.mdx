...
- When a creature within the aura hits with an opportunity attack, the target’s **speed is reduced by [= 2 stride =]** until the end of its next turn.

At **18th level**, the range of this aura increases to **[= 6 stride =]**.
