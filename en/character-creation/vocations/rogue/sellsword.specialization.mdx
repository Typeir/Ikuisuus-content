...
## Blade of the land
- When you wield a **two-handed or unwieldy weapon** that deals **slashing or piercing** damage and **lacks the reach or special properties**. You may use Strength or Dexterity (your choice) for attack and damage rolls.
...
## Aggresive Footwork
When you use your Cunning Action to [# kw:bail #] or [# kw:bolt #], you may **immediately attempt to shove** a creature as part of the **same Minor Action**.
