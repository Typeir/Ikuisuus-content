...
**Dreadful Strike.** During the first round of combat, you can make an additional weapon attack as part of the Attack action you take on that turn. If that attack hits, the target takes an extra **1d8 psychic damage**.
...
| 13           | [Greater Invisibility](/en/library/spells/greater-invisibility) |
| 17           | [Seeming](/en/library/spells/seeming)                           |
