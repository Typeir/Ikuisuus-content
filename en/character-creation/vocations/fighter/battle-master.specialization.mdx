...
- You learn **three [_maneuvers_](/en/library/character-creation/vocations/fighter/maneuvers.reference)** of your choice from the **Maneuver Options** section.
- Many [_maneuvers_](/en/library/character-creation/vocations/fighter/maneuvers.reference) enhance attacks or offer tactical advantages.
- You may only use **one maneuver per attack**.
- You learn **two additional [_maneuvers_](/en/library/character-creation/vocations/fighter/maneuvers.reference)** at **7th, 10th, and 15th level**.
- Each time you gain new [_maneuvers_](/en/library/character-creation/vocations/fighter/maneuvers.reference), you may replace one you know.
