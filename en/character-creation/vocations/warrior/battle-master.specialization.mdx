...
- You regain all expended dice when you finish a **Repose or Recovery**.
...
- You may use this feature **once per Recovery**, or expend **one Superiority Die (no action required)** to restore a use.
