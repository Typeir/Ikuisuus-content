...
Not all rolls in Damocles follow the same structure. This page outlines the special roll variants used across the system beyond the standard checks and rolls described in [Checks and Rolls](/library/rules/the-measure-of-the-self/checks-and-rolls). For the foundational rules on making ability checks, saving throws, and standard mechanics, see that page. For the full description of abilities and skills, see [Abilities and Skills](/library/rules/the-measure-of-the-self/abilities-and-skills).
