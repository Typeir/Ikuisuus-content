...
- You roll **d20 + specified modifier _(score, proficiency, expertise, jack of all trades)_, if any**.
...
**Passive total formula:** 10 + all modifiers that normally apply to the check (ability modifier, proficiency bonus if applicable, and any situational modifiers).
