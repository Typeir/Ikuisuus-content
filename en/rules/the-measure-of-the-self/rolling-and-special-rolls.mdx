...
When the GM rewards exceptional roleplay, the party gains **+1 Deed**. Spending a Deed triggers a **Grit Roll** — a reroll with bonuses tied to Tier Bonus and relevant ability scores. See [Deeds, Grit, and Misdeeds](/en/library/rules/steel-and-strife/deeds-grit-and-misdeeds) for the full rules.
...
| **Grit Roll**              | Spend 1 Deed to reroll with TB + stat bonus. See Deeds & Grit.     |
