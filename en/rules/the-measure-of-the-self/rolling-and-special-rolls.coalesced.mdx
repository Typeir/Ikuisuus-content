...
Skill proficiency is granted by vocation, background, or feats. When proficient in a skill, add your proficiency bonus to ability checks using that skill. The GM may call for a skill paired with an unusual ability (e.g., Strength (Intimidation)) when the situation warrants it; apply proficiency the same way.
