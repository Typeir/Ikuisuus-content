...
Accuracy determines the **sum** of **Modifiers** added to a **Roll**.
Accuracy is also added to the **Difficulty Class** _(DC)_, provided the **feature** imposes a **saving throw** or **check** of any kind.
Each individual feature has a different keyed **modifier** for it's accuracy and damage.
...
When the Game Director rewards exceptional roleplay, the party gains **+1 Deed**. Spending a Deed before a roll lets you declare **Grit** — a bonus tied to Tier Bonus and a relevant ability score. Declare before the die lands; the Deed is spent whether you succeed or fail. See [Deeds, Grit, and Misdeeds](/en/library/rules/steel-and-strife/deeds-grit-and-misdeeds) for the full rules.
...
- Magical effects, items, or magical features do not apply unless specifically stated.
  This includes bonuses from spells like [_Bless_](/en/library/spells/bless), bardic inspiration, or magic items.  
  Non-magical features may apply as long as the **timeframes align**, for example, if the roll represents an immediate process, **Indomitable** can be used.
  Non-magical feats such as [_Lucky_](/en/library/character-creation/feats/lucky) can be used.
...
- A **natural 1** on an **attack roll** is a **critical miss**.  
  The Game Director may assign additional consequences, especially if the miss is reckless or dangerous.
