...
A potion can be **drunk by the user as a bonus action**, as the phials are small and easy to use, and **one might even crush** it and trust the **lesser heirloom** to handle the remnants.
