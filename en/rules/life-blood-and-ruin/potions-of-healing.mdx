...
| Panacea         | Cures all ills, instant Recovery |
...
This limit **resets** once the body is left to rest, with no heavily demanding activity, for at least seven uninterrupted days **(Recovery)**.

| Potions Drunk in One Recovery | Effect                  |
| ----------------------------- | ----------------------- |
| 1–5                           | No side effects         |
...
| **Panacea**         | Cures all, Recovery | All             | 1000000                 | **Variable**           |
