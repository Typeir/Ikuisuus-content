...
This limit **resets** once the body is left to rest, with no heavily demanding activity, for at least seven uninterrupted days [# kw:Recovery #].
...
Potions can be thrown, though this is a risky business. Treat it as a **ranged attack** with a **confirmed roll [CR]** against the target’s Armor Class.
