...
- **Ability Recharge**:  
  Any abilities, heirlooms, or features that recharge on a **short rest** are refreshed after this period of **8 hours**.
- **Limitations**:  
...
- **Interrupted Long Rest**:  
  If a character is interrupted by strenuous combat, levelled spellcasting, or intense exertion, the long rest must begin again.
  Easy encounters may not incur in a loss of progress, if the character **does not fall unconscious during the encounter**, or **spends long-rest related resources**.
- **Benefits of a Long Rest**:
  ...
  - Restore **spell slots and vocation features** that refresh on a long rest.
...
- A long rest must not be **interrupted by no medium, hard or worse encounters, extreme magic usage, or continuous travel** though easier means of travel, such as **a caravan** or a **vehicle** can be considered resting.
...
- To ease technicalities, a long rest also has all of the effects of a **short rest**.
